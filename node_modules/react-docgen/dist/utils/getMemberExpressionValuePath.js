...
function getMemberExpressionValuePath(variableDefinition, memberName) {
  ...
  _recast.default.visit(program, {
    visitAssignmentExpression(path) {
      ...
      if ((!memberPath.node.computed || types.Literal.check(memberPath.node.property)) && (0, _getNameOrValue.default)(memberPath.get('property')) === memberName && (0, _expressionTo.String)(memberPath.get('object')) === localName) {
