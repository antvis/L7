...
function printLiteral(value, type) {
  ...
  if (type instanceof GraphQLEnumType) {
    ...
    !(typeof result === 'string') ? process.env.NODE_ENV !== "production" ? invariant(false, 'GraphQLIRPrinter: Expected value of type %s to be a valid enum value, got `%s`.', type.name, value) : invariant(false) : void 0;
    return result;
  }

  if (type instanceof GraphQLScalarType && value != null) {
    var _result = type.serialize(value);
