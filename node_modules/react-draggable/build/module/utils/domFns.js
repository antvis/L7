...
export function matchesSelector(el
/*: Node*/
, selector
/*: string*/
)
...
export function matchesSelectorAndParentsTo(el
/*: Node*/
, selector
/*: string*/
, baseNode
...
export function removeEvent(el
/*: ?Node*/
, event
/*: string*/
, handler
...
export function offsetXYFromParent(evt
...
export function createCSSTransform(controlPos
/*: ControlPosition*/
, positionOffset
...
export function createSVGTransform(controlPos
/*: ControlPosition*/
, positionOffset
/*: PositionOffsetControlPosition*/
)
...
export function addClassName(el
/*: HTMLElement*/
, className
/*: string*/
) {
...
export function removeClassName(el
/*: HTMLElement*/
, className
/*: string*/
) {
