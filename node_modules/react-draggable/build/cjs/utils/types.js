...
function (_HTMLElement) {
  ...
  return SVGElement;
}(_wrapNativeSuper(HTMLElement)); // Missing targetTouches
...
function (_TouchEvent) {
  ...
  function TouchEvent2() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TouchEvent2)).call.apply(_getPrototypeOf2, [this].concat(args)));
