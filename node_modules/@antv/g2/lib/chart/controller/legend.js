  ...
  _proto._addCategoryLegend = function _addCategoryLegend(scale, attr, geom, filterVals, position) {
    ...
    Util.each(ticks, function (tick) {
      ...
      if (colorAttr) {
        ...
        if (colorAttr.callback && colorAttr.callback.length > 1) {
          ...
          cfg.color = colorAttr.mapping.apply(colorAttr, [value].concat((0, _toConsumableArray2.default)(restArgs))).join('') || viewTheme.defaultColor;
        } else {
      ...
      if (isByAttr && shapeAttr) {
        ...
        if (shapeAttr.callback && shapeAttr.callback.length > 1) {
          ...
          shape = shapeAttr.mapping.apply(shapeAttr, [value].concat((0, _toConsumableArray2.default)(_restArgs))).join('');
        } else {
    ...
    if (self._isTailLegend(legendOptions, geom)) {
      ...
      if (legendOptions.useHtml) {
        ...
        legendCfg.legendStyle.CONTAINER_CLASS = (0, _extends2.default)({}, legendCfg.legendStyle.CONTAINER_CLASS, {
          position: 'absolute',
          overflow: 'auto',
