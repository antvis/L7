...
function areaSlideLeft(shape, animateCfg, coord) {
  ...
  var transitionPath = [].concat((0, _toConsumableArray2.default)(lastPath.slice(0, middleIndex)), [['L', pathPatchPosX, pathPatchPosY], ['L', pathPatchPosX, updatePath[middleIndex][2]]], (0, _toConsumableArray2.default)(lastPath.slice(middleIndex)));
  var v = [0, 0, 1];
  shape.apply(v);
  shape.attr('clip', clip);
  shape.attr('path', transitionPath);
