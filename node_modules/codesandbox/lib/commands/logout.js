        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, confirm_1["default"]("Are you sure you want to log out?")];
                case 2:
                    confirmed = _a.sent();
                    if (!confirmed) return [3 /*break*/, 4];
                    return [4 /*yield*/, cfg_1.deleteUser()];
                case 3:
                    _a.sent();
                    log_1.info("Succesfully logged out");
                    _a.label = 4;
                case 4: return [3 /*break*/, 6];
                case 5:
                    log_1.error("You are already signed out");
                    _a.label = 6;
