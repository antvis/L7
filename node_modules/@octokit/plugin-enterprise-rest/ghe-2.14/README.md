# @octokit/plugin-enterprise-rest/ghe-2.14
...
octokit.checks.requestSuites(head_sha, owner, repo)
...
octokit.orgs.update(billing_email, company, default_repository_permission, description, email, has_organization_projects, has_repository_projects, location, members_can_create_repositories, name, org)
...
octokit.projects.listCards(column_id, page, per_page)
...
octokit.projects.updateCard(card_id, note)
...
octokit.repos.createDeploymentStatus(auto_inactive, deployment_id, description, environment_url, log_url, owner, repo, state, target_url)
