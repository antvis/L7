...
exports.default = util.createRule({
    ...
    create(context, [{ onlyInlineLambdas }]) {
        ...
        function handlePropertyAccessExpression(node, parent, classScope) {
            ...
            if (typescript_1.default.isDeleteExpression(parent) || isDestructuringAssignment(node)) {
        ...
        function isDestructuringAssignment(node) {
            ...
            while (current) {
                ...
                if (typescript_1.default.isObjectLiteralExpression(parent) ||
                    typescript_1.default.isArrayLiteralExpression(parent) ||
                    typescript_1.default.isSpreadAssignment(parent) ||
                    (typescript_1.default.isSpreadElement(parent) &&
                        typescript_1.default.isArrayLiteralExpression(parent.parent))) {
                    current = parent;
                }
        ...
        function getEsNodesFromViolatingNode(violatingNode) {
            if (typescript_1.default.isParameterPropertyDeclaration(violatingNode, violatingNode.parent)) {
                return {
