...
function queueImageResizing({
  ...
  let finishedPromise = Promise.resolve(); // Check if the output file already exists so we don't redo work.
  ...
  if (!fs.existsSync(outputFile)) {
    ...
    finishedPromise = scheduleJob(job, boundActionCreators, pluginOptions, reporter);
  }
