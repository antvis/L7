...
const HeartSvg = () => (
 <img width={16} style={{margin:'5px'}} src='https://mdn.alipayobjects.com/huamei_qa8qxu/afts/img/A*iDSwRorar_QAAAAAAAAAAAAADmJ7AQ/original' alt='react 组件库' />
);
const GitHubButtonBar: React.FC<any> = ({ readingTime }) => {
  return <div style={{float: 'right',display: 'flex',gap:'10px'}}>
    ...
    <Button  icon={<HeartSvg />} style={{fontWeight:600, height:'30px',padding:'1px 6px'}} target='blank' href="https://larkmap.antv.antgroup.com/components/lark-map">React 组件库</Button>
     </div>
};
