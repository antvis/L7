...
const IndexPage = () => {
  ...
  const draw = [
    {
      img:
        'https://gw.alipayobjects.com/mdn/rms_816329/afts/img/A*jQKyTI4-hjAAAAAAAAAAAAAAARQnAQ',
      alt: 'draw circle',
      desc: '绘制圆形',
    },
    {
      img:
        'https://gw.alipayobjects.com/mdn/rms_816329/afts/img/A*PPZ2RJy6XxEAAAAAAAAAAAAAARQnAQ',
      alt: 'draw line',
      desc: '绘制折线',
    },
    {
      img:
        'https://gw.alipayobjects.com/mdn/rms_816329/afts/img/A*f64USbxQhiwAAAAAAAAAAAAAARQnAQ',
      alt: 'draw polygon',
      desc: '绘制几何图形',
    },
  ];
