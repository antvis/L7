...
describe('keyboard', () => {
  test('KeyboardHandler responds to keydown events', () => {
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 32, key: ' ' });
  ...
  test('KeyboardHandler pans map in response to arrow keys', () => {
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 37, key: 'ArrowLeft' });
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 39, key: 'ArrowRight' });
    expect(spy).toHaveBeenCalledTimes(2);
    easeToArgs = spy.mock.calls[1][0];
    expect(easeToArgs.offset[0]).toBe(-100);
    expect(easeToArgs.offset[1]).toBe(-0);

    simulate.keydown(map.getCanvasContainer(), { keyCode: 40, key: 'ArrowDown' });
    expect(spy).toHaveBeenCalledTimes(3);
    easeToArgs = spy.mock.calls[2][0];
    expect(easeToArgs.offset[0]).toBe(-0);
    expect(easeToArgs.offset[1]).toBe(-100);

    simulate.keydown(map.getCanvasContainer(), { keyCode: 38, key: 'ArrowUp' });
  ...
  test('KeyboardHandler rotates map in response to Shift+left/right arrow keys', async () => {
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 37, key: 'ArrowLeft', shiftKey: true });
    expect(map.easeTo).toHaveBeenCalled();
    let easeToArgs = spy.mock.calls[0][0];
    ...
    map.setBearing(0);
    simulate.keydown(map.getCanvasContainer(), { keyCode: 39, key: 'ArrowRight', shiftKey: true });
    expect(spy).toHaveBeenCalledTimes(2);
    easeToArgs = spy.mock.calls[1][0];
    expect(easeToArgs.bearing).toBe(15);
    expect(easeToArgs.offset[0]).toBe(-0);
  ...
  test('KeyboardHandler pitches map in response to Shift+up/down arrow keys', async () => {
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 40, key: 'ArrowDown', shiftKey: true });
    expect(map.easeTo).toHaveBeenCalled();
    let easeToArgs = spy.mock.calls[0][0];
    ...
    map.setPitch(30);
    simulate.keydown(map.getCanvasContainer(), { keyCode: 38, key: 'ArrowUp', shiftKey: true });
    expect(spy).toHaveBeenCalledTimes(2);
    easeToArgs = spy.mock.calls[1][0];
  ...
  test('KeyboardHandler zooms map in response to -/+ keys', () => {
    ...
    simulate.keydown(map.getCanvasContainer(), { keyCode: 187, key: 'Equal' });
    expect(spy).toHaveBeenCalledTimes(1);
    expect(spy.mock.calls[0][0].zoom).toBe(11);

    map.setZoom(10);
    simulate.keydown(map.getCanvasContainer(), { keyCode: 187, key: 'Equal', shiftKey: true });
    expect(spy).toHaveBeenCalledTimes(2);
    expect(spy.mock.calls[1][0].zoom).toBe(12);

    map.setZoom(10);
    simulate.keydown(map.getCanvasContainer(), { keyCode: 189, key: 'Minus' });
    expect(spy).toHaveBeenCalledTimes(3);
    expect(spy.mock.calls[2][0].zoom).toBe(9);

    map.setZoom(10);
    simulate.keydown(map.getCanvasContainer(), { keyCode: 189, key: 'Minus', shiftKey: true });
    expect(spy).toHaveBeenCalledTimes(4);
