...
// /**异步注册3Dcanvas*/
// function registerCanvas(c: HTMLCanvasElement, id: string) {
//   canvas = c;
//   canvas.id = id;
...
//   canvas.addEventListener = function(type: string, listener: any, options = {}) {
//     document.addEventListener(type, listener, options);
//   };

//   canvas.removeEventListener = function(type: string, listener: any) {
...
// /**异步注册2Dcanvas*/
// function registerCanvas2D(ctx: WebGLRenderingContext, id: string) {
//   const width = 1024;
//   const height = 1024;
//   canvas2D = {
//     width,
...
//   canvas2D.getContext = function(type: string) {
//     if (type === "2d") {
//       return ctx;
//     }
//   };
...
//   canvas2D.addEventListener = function(type: string, listener: any, options = {}) {
//     document.addEventListener(type, listener, options);
//   };

//   canvas2D.removeEventListener = function(type: string, listener: any) {
//     document.removeEventListener(type, listener);
//   };
