import { AttributeType, gl, IEncodeFeature, IModel, Triangulation } from '@antv/l7-core';
...
export default class FillModel extends BaseModel {
  ...
  private getModelParams(): { frag: string; vert: string; type: string, triangulation: Triangulation } {
    const {
      opacityLinear = {
        enable: false,
      },
