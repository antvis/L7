jest.mock('../../../src/source/utils/tile/getRasterTile', () => ({
...
jest.mock('../../../src/source/utils/bandOperation/bands', () => ({
...
import { RasterTileLoader } from '../../../src/source/loader/raster-tile-loader';
import { processRasterData } from '../../../src/source/utils/bandOperation/bands';
import {
  defaultFormat,
  getTileBuffer,
  getTileImage,
} from '../../../src/source/utils/tile/getRasterTile';
