...
export default defineConfig({
  ...
  alias: {
    ...
    '@antv/l7-component': path.resolve(__dirname, '../packages/scene/src/component'),
    '@antv/l7-three': path.resolve(__dirname, '../packages/three/src'),
    '@antv/l7-layers': path.resolve(__dirname, '../packages/layers/src'),
    '@antv/l7-map': path.resolve(__dirname, '../packages/maps/src/mapbase'),
    '@antv/l7-maps': path.resolve(__dirname, '../packages/maps/src'),
    '@antv/l7-renderer': path.resolve(__dirname, '../packages/scene/src/renderer'),
    '@antv/l7-scene': path.resolve(__dirname, '../packages/scene/src'),
    '@antv/l7-source': path.resolve(__dirname, '../packages/layers/src/source'),
