import { LineLayer, Map, PointLayer, PolygonLayer, RasterLayer, Scene, Source } from '@antv/l7';
...
const source = new Source('https://cdn.unfolded.ai/indigo/hexify_v5/{z}/{x}/{y}.pbf', {
  parser: {
    type: 'mvt',
    tileSize: 256,
    // minZoom: 9,
...
const layer2 = new PolygonLayer({
  ...
  .color('croptype', ['#C1C9CC', '#DFB02F', '#7F8120', '#DCD0A4', '#AD5633'])
  .style({
    opacity: 1,
  });
