...
export default () => {
  useEffect(() => {
    ...
    fetch('https://tiles.geovisearth.com/geo/v1/district/getDisRange?code=131024',{
      headers:{
        Authorization:'b2a0cfc132cd60b61391b9dd63c15711eadb9b38a9943e3f98160d5710aef788',
      }
    }).then(res=>res.text())
    .then(data =>{
