...
interface IView {lng: number; lat: number, pitch: number, rotation: number, zoom: number}
function changeValue(startValue: number|IView, endValue: number|IView, duration: number = 500, callback: any, complete?: any) {
...
export default class Aspace extends React.Component {
  ...
  public async componentDidMount() {
    ...
    let zspace: THREE.Object3D, aspace: THREE.Object3D, ASpaceTextMesh: THREE.Object3D, ZSpaceTextMesh: THREE.Object3D;
    scene.on('loaded', () => {
      ...
      const threeJSLayer = new ThreeLayer({
        ...
        onAddMeshes: (threeScene: THREE.Scene, layer: ThreeLayer) => {
          ...
          fbxLoaded.load('https://gw.alipayobjects.com/os/bmw-prod/11d6e4c1-bd5b-4dc1-bae5-ac51c14e9056.fbx', (model) => {
            aspace = model;
          ...
          textLoader.load('https://gw.alipayobjects.com/os/bmw-prod/0a3f46eb-294e-4d95-87f2-052c26ad4bf1.json', (font) => {
            ...
            function getH(h1: number, h2: number) {
              changeValue(h1, h2, 1000, (h: number) => {
      ...
      function selectSpace(currentView: IView, targetView: IView, spaceText?: THREE.Object3D) {
        if(spaceText) {
          changeValue(spaceText.rotation.y, spaceText.rotation.y + Math.PI*2, 500, (r: number) => {
