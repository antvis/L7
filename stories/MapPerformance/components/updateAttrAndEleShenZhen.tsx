...
export default class Demo extends React.Component {
  ...
  public async componentDidMount() {
    ...
    scene.on('loaded', () => {
      ...
      fetch('https://gw.alipayobjects.com/os/bmw-prod/6956815b-f2b0-4242-97d6-8f3fea62ea17.txt')
      ...
      .then(res => {
        ...
        array.map(str => {
          ...
          data.slice(2).map((e, i) => {
            ...
            if(e !== undefined && e!== '"' && e !== '' && typeof +e === 'number') {
        ...
        listKeys.map(key => {
          this.state.modelDatas[key + ''] = layer.createModelData(list[key+''], parser);
        })
