...
/*#__PURE__*/
function (_Material) {
  _inherits(hexagonMaterial, _Material);

  _createClass(hexagonMaterial, [{
  ...
  function hexagonMaterial(_uniforms, _defines, parameters) {
    ...
    _classCallCheck(this, hexagonMaterial);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(hexagonMaterial).call(this, parameters));

    var _this$getDefaultParam = _this.getDefaultParameters(),
        defines = _this$getDefaultParam.defines;

    var _getModule = (0, _shaderModule.getModule)('hexagon'),
        vs = _getModule.vs,
        fs = _getModule.fs,
        uniforms = _getModule.uniforms;

    _this.uniforms = (0, _shaderModule.wrapUniforms)((0, _deepMix["default"])(uniforms, _uniforms));
    _this.type = 'hexagonMaterial';
...
exports["default"] = hexagonMaterial;