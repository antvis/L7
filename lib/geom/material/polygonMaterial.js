...
/*#__PURE__*/
function (_Material) {
  _inherits(PolygonMaterial, _Material);
  ...
  function PolygonMaterial(_uniforms, _defines, parameters) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PolygonMaterial).call(this, parameters));

    var _getModule = (0, _shaderModule.getModule)('polygon'),
        vs = _getModule.vs,
        fs = _getModule.fs,
        uniforms = _getModule.uniforms;

    _this.uniforms = (0, _shaderModule.wrapUniforms)((0, _deepMix["default"])(uniforms, _uniforms));
    _this.type = 'PolygonMaterial';
...
exports["default"] = PolygonMaterial;